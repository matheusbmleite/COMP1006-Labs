    ...
    <form method="post" action="process-booking.php">
        <?php
            try {
                ...
                mail('matheusbmleite@gmail.com', 'Book Facility Page Error Connection part', $e);
        ...
        <fieldset>
            ...
            <?php
                try{
                    ...
                    mail('matheusbmleite@gmail.com', 'Book Facility Page Error retrieving customers part', $e);
                    header('location:error.php');
                }
        ...
        <fieldset>
            ...
            <?php
                try {
                    ...
                    mail('matheusbmleite@gmail.com', 'Book Facility Page Error retrieving booking types part', $e);
                    header('location:error.php');
                }
